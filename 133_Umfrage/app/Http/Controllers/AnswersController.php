...
class AnswersController extends Controller {
    ...
    public function getResults() {
        ...
        $current_user_percent = $current_user_score / $total_score * 100;
        ...
        foreach ($users as $key => $user) {
            $users[$key]->percent = round(abs($user->distance - $total_score) / $total_score * 100); // Calculate the percentage from the difference in score
        } 
